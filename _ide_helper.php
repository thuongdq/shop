...
namespace App\ThuongDQ\Facades { 
    ...
    class Tool {
         ...
         * @static 
         */ 
        public static function getThumbnail($fileName, $suffix = '')
        {
            return \App\ThuongDQ\ToolFactory::getThumbnail($fileName, $suffix);
        }
         ...
         * @static 
         */ 
        public static function mediaGetImageSrc($fileName, $suffix)
        {
            return \App\ThuongDQ\ToolFactory::mediaGetImageSrc($fileName, $suffix);
        }
         ...
         * @static 
         */ 
        public static function mediaImageView($fileName, $suffix, $post_title = '', $post_content = '', $class = 'img-responsive', $attribute = '', $lazyload = false)
        {
            return \App\ThuongDQ\ToolFactory::mediaImageView($fileName, $suffix, $post_title, $post_content, $class, $attribute, $lazyload);
        }
         ...
         * @static 
         */ 
        public static function getCurrency($number, $region, $symbol, $isPrefix)
        {
            return \App\ThuongDQ\ToolFactory::getCurrency($number, $region, $symbol, $isPrefix);
        }
         ...
         * @static 
         */ 
        public static function makeCategories($categories)
        {
            return \App\ThuongDQ\ToolFactory::makeCategories($categories);
        }
...
namespace  { 
    ...
    class Tool extends \App\ThuongDQ\Facades\Tool {}

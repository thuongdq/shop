...
@endsection
@section('css-plugins')
    <link href="{{ asset('backend/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css') }}" rel="stylesheet"
          type="text/css"/>
@endsection
@section('css-plugins')
    <link href="{{ asset('backend/pages/css/profile-2.min.css') }}" rel="stylesheet"
          type="text/css"/>
@endsection
@section('js-plugins')
    ...
    <script src="{{ asset('backend/global/plugins/gmaps/gmaps.min.js')}}" type="text/javascript"></script>
@endsection
@section('content')
<!-- BEGIN PAGE BAR -->
<div class="page-bar">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul class="list-unstyled profile-nav">
                            <li>
                                <img src="{{ asset('backend/pages/media/profile/people19.png')}}" class="img-responsive pic-bordered" alt="" />

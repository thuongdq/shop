                            ...
                            <div class="mt-comments">
                                <div class="mt-comment">
                                    <div class="mt-comment-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar1.jpg') }}"/></div>
                                ...
                                <div class="mt-comment">
                                    <div class="mt-comment-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar6.jpg') }}"/></div>
                                    <div class="mt-comment-body">
                                        <div class="mt-comment-info">
                                ...
                                <div class="mt-comment">
                                    <div class="mt-comment-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar8.jpg') }}"/></div>
                                    <div class="mt-comment-body">
                                        <div class="mt-comment-info">
                                ...
                                <div class="mt-comment">
                                    <div class="mt-comment-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar4.jpg') }}"/></div>
                                    <div class="mt-comment-body">
                                        <div class="mt-comment-info">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="mt-actions">
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar10.jpg') }}"/></div>
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar3.jpg') }}"/></div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar2.jpg') }}"/></div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar7.jpg') }}"/></div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar9.jpg') }}"/></div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                        ...
                        <div class="tab-pane" id="tab_actions_completed">
                            ...
                            <div class="mt-actions">
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{ asset('backend/pages/media/users/avatar5.jpg') }}"/></div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                        ...
                        <div class="events-content">
                            <ol>
                                <li class="selected" data-date="16/01/2014">
                                    ...
                                    <div class="mt-author">
                                        <div class="mt-avatar">
                                            <img src="{{ asset('backend/pages/media/users/avatar80_3.jpg') }}"/>
                                        </div>
                                ...
                                <li data-date="20/04/2014">
                                    ...
                                    <div class="mt-author">
                                        <div class="mt-avatar">
                                            <img src="{{ asset('backend/pages/media/users/avatar80_1.jpg') }}"/>
                                        </div>
                                        <div class="mt-author-name">
                                ...
                                <li data-date="20/05/2014">
                                    ...
                                    <div class="mt-author">
                                        <div class="mt-avatar">
                                            <img src="{{ asset('backend/pages/media/users/avatar80_2.jpg') }}"/>
                                        </div>
                                        <div class="mt-author-name">
                                            <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                                        </div>
                                ...
                                <li data-date="30/08/2014">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="mt-content border-grey-steel">
                                        <img class="timeline-body-img pull-left" src="{{ asset('backend/pages/media/blog/5.jpg') }}"
                                             alt="">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio,
                                            dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa
                                            ad debitis unde? Iste voluptatibus minus veritatis
                                ...
                                <li data-date="15/09/2014">
                                    ...
                                    <div class="mt-author">
                                        <div class="mt-avatar">
                                            <img src="{{ asset('backend/pages/media/users/avatar80_5.jpg') }}"/>
                                        </div>
                                        <div class="mt-author-name">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="mt-content border-grey-steel">
                                        <img class="timeline-body-img pull-right" src="{{ asset('backend/pages/media/blog/6.jpg') }}"
                                             alt="">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio,
                                            dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa
                                            ad debitis unde? Iste voluptatibus minus veritatis
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-scrollable table-scrollable-borderless">
                        <table class="table table-hover table-light">
                            ...
                            <tr>
                                <td class="fit">
                                    <img class="user-pic rounded" src="{{ asset('backend/pages/media/users/avatar4.jpg') }}"></td>
                                <td>
                            ...
                            <tr>
                                <td class="fit">
                                    <img class="user-pic rounded" src="{{ asset('backend/pages/media/users/avatar5.jpg') }}"></td>
                                <td>
                            ...
                            <tr>
                                <td class="fit">
                                    <img class="user-pic rounded" src="{{ asset('backend/pages/media/users/avatar6.jpg') }}"></td>
                                <td>
                            ...
                            <tr>
                                <td class="fit">
                                    <img class="user-pic rounded" src="{{ asset('backend/pages/media/users/avatar7.jpg') }}"></td>
                                <td>
                    ...
                    <div class="scroller" style="height: 338px;" data-always-visible="1" data-rail-visible1="0"
                        ...
                        <div class="general-item-list">
                            <div class="item">
                                <div class="item-head">
                                    <div class="item-details">
                                        <img class="item-pic rounded" src="{{ asset('backend/pages/media/users/avatar4.jpg') }}">
                                ...
                                <div class="item-body"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed
                            ...
                            <div class="item">
                                <div class="item-head">
                                    <div class="item-details">
                                        <img class="item-pic rounded" src="{{ asset('backend/pages/media/users/avatar3.jpg') }}">
                            ...
                            <div class="item">
                                <div class="item-head">
                                    <div class="item-details">
                                        <img class="item-pic rounded" src="{{ asset('backend/pages/media/users/avatar6.jpg') }}">
                                        <a href="" class="item-name primary-link">Nick Larson</a>
                            ...
                            <div class="item">
                                <div class="item-head">
                                    <div class="item-details">
                                        <img class="item-pic rounded" src="{{ asset('backend/pages/media/users/avatar7.jpg') }}">
                                        <a href="" class="item-name primary-link">Nick Larson</a>
                            ...
                            <div class="item">
                                <div class="item-head">
                                    <div class="item-details">
                                        <img class="item-pic rounded" src="{{ asset('backend/pages/media/users/avatar9.jpg') }}">
                                ...
                                <div class="item-body"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, ut
                            ...
                            <div class="item">
                                <div class="item-head">
                                    <div class="item-details">
                                        <img class="item-pic rounded" src="{{ asset('backend/pages/media/users/avatar8.jpg') }}">
                                ...
                                <div class="item-body"> Lorem ipsum dolor sit amet, sed diam nonummy nibh euismod
                            ...
                            <div class="item">
                                <div class="item-head">
                                    <div class="item-details">
                                        <img class="item-pic rounded" src="{{ asset('backend/pages/media/users/avatar2.jpg') }}">
            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body">
                    <div id="region_statistics_loading">
                        <img src="{{ asset('backend/global/img/loading.gif') }}" alt="loading"/></div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="mt-widget-1">
                                ...
                                <div class="mt-img">
                                    <img src="{{ asset('backend/pages/media/users/avatar80_8.jpg') }}"></div>
                                <div class="mt-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mt-widget-1">
                                ...
                                <div class="mt-img">
                                    <img src="{{ asset('backend/pages/media/users/avatar80_7.jpg') }}"></div>
                                <div class="mt-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mt-widget-1">
                                ...
                                <div class="mt-img">
                                    <img src="{{ asset('backend/pages/media/users/avatar80_6.jpg') }}"></div>
                                <div class="mt-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mt-widget-2">
                                <div class="mt-head"
                                     style="background-image: url(../admin/pages/img/background/32.jpg);">
                                    <div class="mt-head-label">
                                        <button type="button" class="btn btn-success">Manhattan</button>
                                    </div>
                                    <div class="mt-head-user">
                                        <div class="mt-head-user-img">
                                            <img src="{{ asset('backend/pages/img/avatars/team7.jpg') }}"></div>
                        ...
                        <div class="col-md-6">
                            <div class="mt-widget-2">
                                <div class="mt-head"
                                     style="background-image: url(../admin/pages/img/background/43.jpg);">
                                    <div class="mt-head-label">
                                        <button type="button" class="btn btn-danger">London</button>
                                    </div>
                                    <div class="mt-head-user">
                                        <div class="mt-head-user-img">
                                            <img src="{{ asset('backend/pages/img/avatars/team3.jpg') }}"></div>
                                        <div class="mt-head-user-info">
                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mt-widget-4">
                                <div class="mt-img-container">
                                    <img src="{{ asset('backend/pages/img/background/34.jpg') }}"/></div>
                        ...
                        <div class="col-md-4">
                            <div class="mt-widget-4">
                                <div class="mt-img-container">
                                    <img src="{{ asset('backend/pages/img/background/46.jpg') }}"/></div>
                        ...
                        <div class="col-md-4">
                            <div class="mt-widget-4">
                                <div class="mt-img-container">
                                    <img src="{{ asset('backend/pages/img/background/37.jpg') }}"/></div>

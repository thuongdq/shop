...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" href="{{ asset('frontend/default/assets/css/bootstrap.min.css') }}">

    <!-- Customizable CSS -->
    {{--<link rel="stylesheet" href="{{ asset('frontend/default/assets/css/main.css') }}">--}}
    {{--<link rel="stylesheet" href="{{ asset('frontend/default/assets/css/blue.css') }}">--}}
    {{--<link rel="stylesheet" href="{{ asset('frontend/default/assets/css/owl.carousel.css') }}">--}}
    {{--<link rel="stylesheet" href="{{ asset('frontend/default/assets/css/owl.transitions.css') }}">--}}
    {{--<link rel="stylesheet" href="{{ asset('frontend/default/assets/css/animate.min.css') }}">--}}
    {{--<link rel="stylesheet" href="{{ asset('frontend/default/assets/css/custom.css') }}">--}}
    <!-- Fonts -->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800' rel='stylesheet' type='text/css'>

    <!-- Icons/Glyphs -->
{{--    <link rel="stylesheet" href="{{ asset('frontend/default/assets/css/font-awesome.min.css') }}">--}}

    <link rel="stylesheet" href="{{ asset('asset/app.css') }}">
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('frontend/default/assets/images/favicon.ico') }}">

{{-- Theme Styles --}}
@yield('styles')
<!-- HTML5 elements and media queries Support for IE8 : HTML5 shim and Respond.js -->
    <!--[if lt IE 9]>
    <script src="{{ asset('frontend/default/assets/js/html5shiv.js') }}"></script>
    <script src="{{ asset('frontend/default/assets/js/respond.min.js') }}"></script>
    <![endif]-->
...
<div class="wrapper" id="app">
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul class="right">
                    ...
                    @else
                        <li>Xin chào, {{ auth()->user()->name }} ( <a href="{{ route('frontend.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit()" >Đăng xuất</a> )</li>
    ...
    <!-- ============================================================= TOP NAVIGATION : END ============================================================= -->
    <!-- ============================================================= HEADER ============================================================= -->
    <header class="{{ Route::currentRouteName() !== 'frontend.home.index' ? "no-padding header-alt" : '' }}">
        <div class="container no-padding">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                ...
                <div class="logo">
                    ...
                    <!--<img alt="logo" src="{{ asset('frontend/default/assets/images/logo.svg') }}" width="233" height="54"/>-->
                    <!--<object id="sp" type="image/svg+xml" data="{{ asset('frontend/default/assets/images/logo.svg') }}" width="233" height="54"></object>-->
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 top-search-holder no-margin">
                ...
                <div class="search-area">
                    <form action="{{ route('frontend.home.productIndex') }}" method="get" id="search-form">
                        <div class="control-group">
                            ...
                            <ul class="categories-filter animate-dropdown">
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="category-grid.html">Chuyên mục</a>
                                    <ul class="dropdown-menu" role="menu">
                                        {{--@foreach($categories as $category)--}}
                                            {{--<li role="presentation">--}}
                                                {{--<a role="menuitem" tabindex="-1" href="category-grid.html">{{ $category->name }}</a>--}}
                                            {{--</li>--}}
                                        {{--@endforeach--}}
                                    </ul>
                                </li>
                        ...
                        <div class="basket">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                <div class="basket-item-count">
                                    ...
                                    <img src="{{ asset('frontend/default/assets/images/icon-cart.png') }}" alt=""/>
                                </div>
                            ...
                            <ul class="dropdown-menu">
                                <li v-for="(product,key) in cart">
                                    <div class="basket-item">
                                        ...
                                        <a href="#" v-on:click="deleteCart(key, $event)" class="close-btn"></a>
                                    </div>
                                </li>
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                @if(count($categories[0]) > 0)
                                    @foreach($categories[0] as $category)
                                        <li class="dropdown">
                                            <a href="{{ route('frontend.home.productIndex', ['category' => $category->id]) }}" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">
                                                {{ $category->name }}
                                            </a>
                                            ...
                                            <ul class="dropdown-menu">
                                                @foreach($categories[$category->id] as $childCategory)
                                                    <li>
                                                        <a href="{{ route('frontend.home.productIndex', ['category'=>$category->id]) }}">
                                                            {{ $childCategory->name }}
                                                        </a>
                                                    </li>
                                                @endforeach

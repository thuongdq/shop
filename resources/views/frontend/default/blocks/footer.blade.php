                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-01.jpg') }}"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-02.jpg') }}"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-03.jpg') }}"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-04.jpg') }}"/>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-05.jpg') }}"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-06.jpg') }}"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-07.jpg') }}"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-08.jpg') }}"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                                 data-echo="{{ asset('frontend/default/assets/images/products/product-small-09.jpg') }}"/>
                                        </a>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="{{ asset('frontend/default/assets/images/payments/payment-visa.png') }}">
                        </li>
                        <li><img alt=""
                                 src="{{ asset('frontend/default/assets/images/payments/payment-master.png') }}"></li>
                        <li><img alt=""
                                 src="{{ asset('frontend/default/assets/images/payments/payment-paypal.png') }}"></li>
                        <li><img alt=""
                                 src="{{ asset('frontend/default/assets/images/payments/payment-skrill.png') }}"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
...
{{--<script src="{{ asset('frontend/default/assets/js/jquery-1.10.2.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/jquery-migrate-1.2.1.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/bootstrap.min.js') }}"></script>--}}
{{--<script src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/gmap3.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/bootstrap-hover-dropdown.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/owl.carousel.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/css_browser_selector.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/echo.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/jquery.easing-1.3.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/bootstrap-slider.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/jquery.raty.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/jquery.prettyPhoto.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/jquery.customSelect.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/wow.min.js') }}"></script>--}}
{{--<script src="{{ asset('frontend/default/assets/js/scripts.js') }}"></script>--}}
...
<script type="text/javascript">
    ...
    new Vue({
        ...
        methods:{
            ...
            deleteCart: function(id, event){
                event.preventDefault();
                var vm = this;
                axios.put('{{ route('api.cart.deleteCart') }}', {id: id}).then(function (response) {
                    vm.cart = response && response.data && response.data.cart;
                    vm.total = response && response.data && response.data.total;
                    vm.sumPrice = response && response.data && response.data.sumPrice;
                });

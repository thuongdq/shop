                        ...
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                                <img class="img-responsive" alt=""
                                     ...
                                     data-echo="{{ asset('frontend/default/assets/images/products/product-gallery-01.jpg') }}"/>
                            </a>
                    ...
                    <div class="single-product-gallery-thumbs gallery-thumbs">
                        ...
                        <div id="owl-single-product-thumbnails">
                            <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0"
                               href="#slide1">
                                <img width="67" alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                     data-echo="{{ asset('frontend/default/assets/images/products/gallery-thumb-01.jpg') }}"/>
                            </a>
                ...
                <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                        ...
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                     data-echo="{{ asset('frontend/default/assets/images/products/product-11.jpg') }}"/>
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class="no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                     data-echo="{{ asset('frontend/default/assets/images/products/product-12.jpg') }}"/>
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                     data-echo="{{ asset('frontend/default/assets/images/products/product-13.jpg') }}"/>
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                     data-echo="{{ asset('frontend/default/assets/images/products/product-14.jpg') }}"/>
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                     data-echo="{{ asset('frontend/default/assets/images/products/product-15.jpg') }}"/>
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="{{ asset('frontend/default/assets/images/blank.gif') }}"
                                     data-echo="{{ asset('frontend/default/assets/images/products/product-16.jpg') }}"/>
                            </div>
                            <div class="body">
                                <div class="title">
